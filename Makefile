...
pkglibexecdir = $(libexecdir)/insight
...
am__v_CCLD_1 = 
SOURCES = $(xsight_SOURCES)
DIST_SOURCES = $(xsight_SOURCES)
...
ACLOCAL = ${SHELL} /home/rapier/src/xsight-listener/missing aclocal-1.15
AMTAR = $${TAR-tar}
...
AUTOMAKE = ${SHELL} /home/rapier/src/xsight-listener/missing automake-1.15
AWK = gawk
CC = gcc
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lcrypto -lconfig -lcurl -lestats -lpthread 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/rapier/src/xsight-listener/missing makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
PACKAGE = insight
PACKAGE_BUGREPORT = rapier@psc.edu
PACKAGE_NAME = insight
PACKAGE_STRING = insight 0.1
PACKAGE_TARNAME = insight
PACKAGE_URL = 
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
SET_MAKE = 
...
xsight$(EXEEXT): $(xsight_OBJECTS) $(xsight_DEPENDENCIES) $(EXTRA_xsight_DEPENDENCIES) 
	@rm -f xsight$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(xsight_OBJECTS) $(xsight_LDADD) $(LIBS)
